...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker> {
	...
	protected boolean showThreatCircle = false;

	public boolean isShowThreatCircle() {
		return this.showThreatCircle;
	}

	public void setIsShowThreatCircle(boolean b) {
		this.showThreatCircle = b;
	}
	...
	public int compareTo(EarthquakeMarker other) {
		// Sort it in reverse order of magnitude, higher needs to return negative
	...
	public void drawMarker(PGraphics pg, float x, float y) {
		...
		// If showRadius, draw a radius of threatCircle with alphas
		if (showThreatCircle) {
			float threatCircle = (float) this.threatCircle();
			pg.noStroke();
			pg.fill(255, 0, 0, 2.5f);
