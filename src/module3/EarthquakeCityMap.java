...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {
		...
		// The coordinates of the main map
		// x , y , w , h
		// 200, 50, 700, 500

		// Create the box for the legends
		fill(255);
		stroke(0);
		rect(20, 50, 160, 180);
		...
		int xCoorDot = 50, xCoorLegend = 70;
		int yCoorDot = 110, yCoorLegend = 115, yCoorIncrement = 40;

		// Red dot
		fill(255, 0, 0);
		ellipse(xCoorDot, yCoorDot, 20, 20);
		fill(0);
		text("Magnitude 5.0+", xCoorLegend, yCoorLegend);

		// Yellow dot
		fill(255, 255, 0);
		ellipse(xCoorDot, yCoorDot + yCoorIncrement, 15, 15);
		fill(0);
		text("Magnitude 4.0+", xCoorLegend, yCoorLegend + yCoorIncrement);

		// Blue dot
		fill(0, 0, 255);
		ellipse(xCoorDot, yCoorDot + yCoorIncrement * 2, 10, 10);
		fill(0);
		text("Magnitude 4.0+", xCoorLegend, yCoorLegend + yCoorIncrement * 2);
	}
}
